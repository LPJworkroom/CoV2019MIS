   ...
   public abstract class MySQLHelper
    {
        ...
        private static readonly string connectionString = "server=XXX.mysql.rds.aliyuncs.com;database=XXX;user=root;password=123456;port=3306;Charset=utf8;Pooling=true;Max Pool Size=50;";
